...
function gestionarXml(dadesXml){
	...
	respuestaInput=xmlDoc.getElementById("pregunta1").getElementsByTagName("answer")[0].innerHTML;
	//Text 2
	//Recuperamos el título y la respuesta correcta de Input, guardamos 
	var tituloInput2=xmlDoc.getElementsByTagName("title")[5].innerHTML;
	ponerDatosInput2Html(tituloInput2);
	respuestaInput2=xmlDoc.getElementById("pregunta6").getElementsByTagName("answer")[0].innerHTML;
	//Select 1
	...
	for (i = 0; i < nopt; i++) { 
		opcionesSelect[i] = xmlDoc.getElementById("pregunta2").getElementsByTagName('option')[i].innerHTML;
	}
	...
	for (i = 0; i < nopt; i++) { 
		opcionesSelect2[i] = xmlDoc.getElementById("pregunta7").getElementsByTagName('option')[i].innerHTML;
	}
	
	ponerDatosSelectHtml2(tituloSelect2,opcionesSelect2);
	respuestaSelect2= parseInt(xmlDoc.getElementById("pregunta7").getElementsByTagName("answer")[0].innerHTML);
	...
	var nopt = xmlDoc.getElementById("pregunta3").getElementsByTagName('option').length;
	for (i = 0; i < nopt; i++) { 
		opcionesCheckbox[i]=xmlDoc.getElementById("pregunta3").getElementsByTagName('option')[i].innerHTML;
	}  
	
	ponerDatosCheckboxHtml(tituloCheckbox,opcionesCheckbox);
	var nres = xmlDoc.getElementById("pregunta3").getElementsByTagName('answer').length;
	for (i = 0; i < nres; i++) { 
		respuestasCheckbox[i]=xmlDoc.getElementById("pregunta3").getElementsByTagName("answer")[i].innerHTML;
	}
	...
	for (i = 0; i < nopt; i++) { 
		opcionesCheckbox2[i]=xmlDoc.getElementById("pregunta8").getElementsByTagName('option')[i].innerHTML;
	}  
	ponerDatosCheckboxHtml2(tituloCheckbox2,opcionesCheckbox2);
	var nres = xmlDoc.getElementById("pregunta8").getElementsByTagName('answer').length;
	for (i = 0; i < nres; i++) { 
		respuestasCheckbox2[i]=xmlDoc.getElementById("pregunta8").getElementsByTagName("answer")[i].innerHTML;
	}
	//Radio 1
	...
	var opcionesRadio = [];
	var nopt = xmlDoc.getElementById("pregunta4").getElementsByTagName('option').length;
	for (i = 0; i < nopt; i++) { 
		opcionesRadio[i]=xmlDoc.getElementById("pregunta4").getElementsByTagName('option')[i].innerHTML;
	}  
	ponerDatosRadio(tituloRadio,opcionesRadio);
	respuestaRadio=xmlDoc.getElementById("pregunta4").getElementsByTagName("answer")[0].innerHTML;	
	...
	for (i = 0; i < nopt; i++) { 
		opcionesRadio2[i]=xmlDoc.getElementById("pregunta9").getElementsByTagName('option')[i].innerHTML;
	}  
	ponerDatosRadio2(tituloRadio2,opcionesRadio2);
	respuestaRadio2=xmlDoc.getElementById("pregunta9").getElementsByTagName("answer")[0].innerHTML;	
	//Multiple 1
	...
	for (i = 0; i < nopt; i++) { 
		opcionesSelectMultiple[i] = xmlDoc.getElementById("pregunta5").getElementsByTagName('option')[i].innerHTML;
	}
	...
	for (i = 0; i < nres; i++) { 
		respuestasMultiple[i]=xmlDoc.getElementById("pregunta5").getElementsByTagName("answer")[i].innerHTML;
	}
	//Multiple 2
	//Recuperamos el título y las opciones, guardamos la respuesta correcta
	...
	for (i = 0; i < nopt; i++) { 
		opcionesSelectMultiple2[i] = xmlDoc.getElementById("pregunta10").getElementsByTagName('option')[i].innerHTML;
	}
	...
	for (i = 0; i < nres; i++) { 
		respuestasMultiple2[i]=xmlDoc.getElementById("pregunta10").getElementsByTagName("answer")[i].innerHTML;
	}
}
